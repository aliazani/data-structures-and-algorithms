...
@DisplayName("MyHashTableDoubleHashing")
class MyHashTableDoubleHashingTest {
    MyHashTableDoubleHashing<Integer, String> table;

    @BeforeEach
    void setUp() {
        table = new MyHashTableDoubleHashing<>(5);
    }
    ...
    void put_addNewKeyValuePairWithHashCollision_addToCorrectSlot() {
        ...
        assertEquals("[0=a, 1=b, 5=c, null, 10=d]", table.toString());
    }
